...
/**
 * The code is token from OSDev Wiki
 * Most of these functions are standard
 */
...
// List won't work without this
/*
void std::__detail::_List_node_base::_M_hook(std::__detail::_List_node_base* pos)
{
